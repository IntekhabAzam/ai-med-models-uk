...
with col1:
    ...
    st.markdown("<p style='text-align:justify; color: #000'>Aimed is a rapidly growing software startup specializing in artificial intelligence (AI) solutions for the healthcare industry. Partner companies founded in 2021, the company has developed a proprietary AI healthcare platform that enhances diagnostic improves patients outcome by optimising treatment plans and predicting potential health issues before comes to critical stages.</p>", unsafe_allow_html=True)
